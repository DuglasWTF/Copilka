...
<form method="post">
	...
	<p> Дата <input type="datetime-local" name="calendar"> Потраченная сумма <input type = "number" name = "spendInp"> Комментарий <input name = "comment"> <button type="submit">Submit</button> </p>
